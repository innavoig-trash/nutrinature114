...
<div x-data="{
    ...
    <div x-show="show"
        class="mb-6 bg-white dark:bg-zinc-800 rounded-lg overflow-hidden transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-zinc-200 dark:border-zinc-700"
